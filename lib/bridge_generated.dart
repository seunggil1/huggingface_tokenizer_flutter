...
abstract class FlutterRustBridgeExample {
  Future<Uint32List> encode({required String input, dynamic hint});
...
class FlutterRustBridgeExampleImpl implements FlutterRustBridgeExample {
  ...
  Future<Uint32List> encode({required String input, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_encode(port_, arg0),
...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_encodePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_encode');
  late final _wire_encode = _wire_encodePtr
